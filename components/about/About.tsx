      ...
      <div className="mx-auto flex w-[90%] flex-col items-start justify-center lg:max-w-[1212.8px]">
        ...
        <div className="mx-auto flex w-full flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          <div className="lg:mg-16 mb-10 flex w-full flex-col gap-4 text-[18px] font-medium leading-relaxed tracking-wide md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:max-w-[90%] lg:text-base">
            <AnimateParagraph
              paragraph="Hi, I'm Robby Novianto, a passionate Fullstack Developer currently working at Hwaseung Pati. I specialize in building dynamic, scalable, and efficient applications, leveraging my expertise in both front-end and back-end technologies."
              delay={1.5}
            />
            <AnimateParagraph
              paragraph="I'm particularly enthusiastic about modern web technologies, with a deep focus on React and TypeScript. My journey in tech is fueled by an insatiable curiosity to learn and adapt to the ever-evolving digital landscape."
              delay={1.8}
            />
            <AnimateParagraph
              paragraph="When I'm not coding, you'll likely find me exploring new tools, frameworks, and best practices to enhance my development workflow. Let's build something amazing together! 🚀"
              delay={2}
            />
          </div>
